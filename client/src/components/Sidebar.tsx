...
import { BotIcon, EyeIcon, Loader2, Send, UserIcon } from "lucide-react";
        ...
        <div className='flex-1 overflow-y-auto no-scrollbar px-3 flex flex-col gap-4'>
          {[...project.conversation, ...project.versions]
            ...
            .map((message) => {
                  ...
                  >
                    {!isUser && (
                      <div className='w-8 h-8 rounded-full bg-linear-to-br from-indigo-600 to-indigo-700 flex items-center justify-center'>
                        <BotIcon className='size-5 text-ehite' />
                      </div>
                    )}
              ...
              return (
                <div key={ver.id} className='w-4/5 mx-auto my-2 p-3 rounded-x1 bg-gray-800 text-100 shadow flex flex-col gap-2'>
